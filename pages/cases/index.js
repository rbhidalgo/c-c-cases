                            ...
                            <div className={styles.cases__category_card}>
                                ...
                                <div className={styles.cases__catgory_wrapper}>
                                    <div className={styles.cases__category_case}>
                                        <h3>AUDIO & SOUND</h3>
                                        <ul>
                                            <li><Link href="/cases/audio-and-sound/#console" passHref className="link">Consoles<span className={styles.arrow}>&#9656;</span></Link></li>
                                            <li><Link href="/cases/audio-and-sound/#speaker" passHref className="link">Speakers<span className={styles.arrow}>&#9656;</span></Link></li>
                                            <li><Link href="/cases/audio-and-sound/#dog-house" passHref className="link">Dog House<span className={styles.arrow}>&#9656;</span></Link></li>
                                        </ul>
                                    </div>
                                    <hr />
                                    <div className={styles.cases__category_case}>
                            ...
                            <div className={styles.cases__category_card}>
                                ...
                                <div className={styles.cases__catgory_wrapper}>
                                    <div className={styles.cases__category_case}>
                                        ...
                                        <ul>
                                            <li><Link
                                                href="/cases/musical-instruments-and-gear/#keyboard"
                                                passHref
                                                className="link">Keyboards<span className={styles.arrow}>&#9656;</span></Link></li>
                                            <li><Link
                                                href="/cases/musical-instruments-and-gear/#amplifier"
                                                passHref
                                                className="link">Amplifiers<span className={styles.arrow}>&#9656;</span></Link></li>
                                            <li><Link
                                                href="/cases/musical-instruments-and-gear/#studio-monitors"
                                                passHref
                                                className="link">Studio Monitors<span className={styles.arrow}>&#9656;</span></Link></li>
                                        </ul>
                                    </div>
                                    <hr />
                                    <div className={styles.cases__category_case}>
                            ...
                            <div className={styles.cases__category_card}>
                                ...
                                <div className={styles.cases__catgory_wrapper}>
                                    <div className={styles.cases__category_case}>
                                        <h3>FILM</h3>
                                        <ul>
                                            <li><Link href="/cases/film/#camera" passHref className="link">Cameras<span className={styles.arrow}>&#9656;</span></Link></li>
                                            <li><Link href="/cases/film/#camera" passHref className="link">Film Lenses<span className={styles.arrow}>&#9656;</span></Link></li>
