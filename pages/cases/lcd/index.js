...
export default function AudioSound() {
	return (
		<>
			<Head>
				<title>
					Custom LCD | ATA Flight Cases in Los Angeles, California – C&C Cases Inc.
				</title>
				<meta
					name='description'
				...
				<section className={styles.cases}>
					...
					<div className={styles.wrapper}>
						<div className={styles.cases__heading}>
							<h1 className={styles.heading__title}>Custom LCD Road Cases | ATA Flight Cases - Made in the USA 🇺🇸</h1>
