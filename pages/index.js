                            ...
                            <div className={styles.cases__category_card}>
                                ...
                                <div className={styles.cases__catgory_wrapper}>
                                    <div className={styles.cases__category_case}>
                                        <h3>AUDIO & SOUND</h3>
                                        <ul>
                                            <li><Link href="/cases/audio-and-sound/#console" passHref className="link">Consoles</Link></li>
                                            <li><Link href="/cases/audio-and-sound/#speaker" passHref className="link">Speakers</Link></li>
                                            <li><Link href="/cases/audio-and-sound/#dog-house" passHref className="link">Dog House</Link></li>
                                        </ul>
                                        <Link href="/cases/audio-and-sound/" className="link">
                                            VIEW ALL CASES<span className={styles.arrow}>&#9656;</span>
                                        </Link>
                                    </div>
                                    <hr />
                                    <div className={styles.cases__category_case}>
                                    ...
                                    <div className={styles.cases__category_case}>
                                        ...
                                        <ul>
                                            <li><Link
                                                ...
                                                passHref
                                                className="link">Keyboards</Link></li>
                                            <li><Link
                                                href="/cases/musical-instruments-and-gear/#amplifier"
                                                passHref
                                                className="link">Amplifiers</Link></li>
                                            <li><Link
                                                href="/cases/musical-instruments-and-gear/#studio-monitors"
                                                passHref
                                                className="link">Studio Monitors</Link></li>
                                        </ul>
                                        <Link href="/cases/musical-instruments-and-gear/" className="link">
                                            VIEW ALL CASES<span className={styles.arrow}>&#9656;</span>
                                        </Link>
                                    </div>
                                    <hr />
                            ...
                            <div className={styles.cases__category_card}>
                                ...
                                <div className={styles.cases__catgory_wrapper}>
                                    <div className={styles.cases__category_case}>
                                        <h3>FILM</h3>
                                        <ul>
                                            <li><Link href="/cases/film/#camera" passHref className="link">Cameras</Link></li>
                                            <li><Link href="/cases/film/#camera" passHref className="link">Film Lenses</Link></li>
                                            <li>Camera Sliders</li>
                                        </ul>
                                        <Link href="/cases/film/" className="link">
                                            VIEW ALL CASES<span className={styles.arrow}>&#9656;</span>
                                        </Link>
                                    </div>
                                    <hr />
