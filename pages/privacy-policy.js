...
const About = () => {
	return (
		...
		<div className={styles.wrapper}>
			<div className={styles.cases__heading}>
				<h1 className={styles.heading__title}>Privacy Policy</h1>
    ...
    <li>
    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to C&amp;C Cases Inc., 300 S. Sycamore Ave. Bldg B Rialto CA, 92376.</p>
    </li>
    <li>
    ...
    <li>
    <p><strong>Website</strong> refers to C&amp;C Cases Inc, accessible from <a href="https://www.ccroadcases.com" rel="external nofollow noopener" target="_blank">https://www.ccroadcases.com</a></p>
    </li>
    <li>
    ...
    <p>We do not sell personal information as the term sell is commonly understood. We do allow Service Providers to use Your personal information for the business purposes described in Our Privacy Policy, for activities such as advertising, marketing, and analytics, and these may be deemed a aale under CCPA/CPRA.</p>
    ...
    <ul>
    <li>
    <p>By email: sales@ccroadcases.com</p>
    </li>
    <li>
    <p>By visiting this page on our website: <a href="https://www.ccroadcases.com/contact/" rel="external nofollow noopener" target="_blank">https://www.ccroadcases.com/contact/</a></p>
    </li>
    </ul>
